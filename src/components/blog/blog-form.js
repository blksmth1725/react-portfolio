...
export default class BlogForm extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      content: "",
      featured_image: "",
      apiUrl: "https://christiansheen.devcamp.space/portfolio/portfolio_blogs",
      apiAction: "post"
    };
  ...
  componentWillMount() {
    if (this.props.editMode) {
      this.setState({
        ...
        apiUrl: `https://christiansheen.devcamp.space/portfolio/portfolio_blogs/${this.props.blog.id}`,
        apiAction: "patch"
      });
    }
  }
      ...
      <form onSubmit={this.handleSubmit} className="blog-form-wrapper">
        ...
        <div className="image-uploaders">
          {this.props.editMode && this.props.blog.featured_image_url ? (
            ...
            >
              <div className="ds-message">Featured Image</div>
            </DropzoneComponent>
          )}
        </div>
