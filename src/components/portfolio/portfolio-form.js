...
export default class PortfolioForm extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      logo: "",
      editMode: false,
      apiUrl: "https://christiansheen.devcamp.space/portfolio/portfolio_items",
      apiAction: "post"
    };
  ...
  componentDidUpdate() {
    if (Object.keys(this.props.portfolioToEdit).length > 0) {
      ...
      this.setState({
        ...
        url: url || "",
        editMode: true,
        apiUrl: `https://christiansheen.devcamp.space/portfolio/portfolio_items/${id}`,
        apiAction: "patch",
    ...
    axios({
      ...
      .then(response => {
        ...
        this.setState({
          ...
          editMode: false,
          apiUrl:
            "https://christiansheen.devcamp.space/portfolio/portfolio_items",
          apiAction: "post"
        });
